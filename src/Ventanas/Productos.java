...
public class Productos extends javax.swing.JFrame {
    ...
    public Productos() {
        ...
        List<Producto> productos = Main.listaProductos;
        
        StringBuilder productList = new StringBuilder();
        for (Producto producto : productos) {
            productList.append(producto.mostrarInfo()).append("\n");
        }

        // Set the text in the JTextArea
        textoproductos.setText(productList.toString());
    ...
    private void initComponents() {
        ...
        jProd = new javax.swing.JScrollPane();
        ...
        textoproductos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        textoproductos.setRows(5);
        jProd.setViewportView(textoproductos);

        getContentPane().add(jProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 430, 480));
    ...
    private javax.swing.JScrollPane jProd;
